...
public class Alta {
    ...
    public static void cargarAulas(Connection conexion, ArrayList<Aula> aulas) {
        try {
    ...
    public static void cargarCarreras(Connection conexion, ArrayList<Carrera> carreras) {
        try {
            PreparedStatement preparacion;
    ...
    public static void cargarCategorias(Connection conexion, ArrayList<Categoria> categorias) {
        try {
            PreparedStatement preparacion;
    ...
    public static void cargarEquipos(Connection conexion, ArrayList<Equipo> equipos) {
        try {
            PreparedStatement preparacion;
    ...
    public static void cargarGrupos(Connection conexion, ArrayList<Grupo> grupos) {
        try {
            PreparedStatement preparacion;
    ...
    public static void cargarMaterias(Connection conexion, ArrayList<Materia> materias) {
        try {
            PreparedStatement preparacion;
    ...
    public static void cargarPlanEstudio(Connection conexion, ArrayList<PlanEstudio> planEstudios) {
        try {
            PreparedStatement preparacion;
    ...
    public static void cargarUsuarios(Connection conexion, ArrayList<Usuario> usuarios) {
        try {
            PreparedStatement preparacion;
