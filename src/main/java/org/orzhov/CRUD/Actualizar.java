...
public class Actualizar {
    public static void actualizarAulas(Connection conexion, ArrayList<Aula> aulas, String id) {
        try {
    ...
    public static void actualizarCarreras(Connection conexion, ArrayList<Carrera> carreras, String id) {
        try {
            PreparedStatement preparacion;
    ...
    public static void actualizarCategorias(Connection conexion, ArrayList<Categoria> categorias, String id) {
        try {
            PreparedStatement preparacion;
    ...
    public static void actualizarEquipos(Connection conexion, ArrayList<Equipo> equipos, String id) {
        try {
            PreparedStatement preparacion;
    ...
    public static void actualizarGrupos(Connection conexion, ArrayList<Grupo> grupos, String id) {
        try {
            PreparedStatement preparacion;
    ...
    public static void actualizarPlanEstudio(Connection conexion, ArrayList<PlanEstudio> planEstudios, String id) {
        try {
            PreparedStatement preparacion;
    ...
    public static void actualizarUsuarios(Connection conexion, ArrayList<Usuario> usuarios, String id) {
        try {
            PreparedStatement preparacion;
